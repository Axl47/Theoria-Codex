...
internal fun rememberTheoriaAppGraph(
    ...
    val tagSuggestionStore = remember(appContext) {
        val application = appContext as? TheoriaApplication
            ?: error("TheoriaApp requires TheoriaApplication as its application context")
        application.tagSuggestionStore
    }
