...
- Codex tab now uses a board-style tile layout, with codex actions moved to a long-press action sheet (Download/Search/Rename/Delete), and a dedicated Reorder mode that supports drag-and-drop ordering with persisted order
