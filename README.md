...
- After completing an update install, first launch now shows a one-time “What’s new” dialog using the same release-note sections, then clears after dismissal
